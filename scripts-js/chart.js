 ...
 */
const showChart = () => {
    let chartElement = document.querySelector('.data_chart'), spinnerElement = document.querySelector('.chart_spinner'), canvasWrapper = document.querySelector('.canvas_wrapper');
